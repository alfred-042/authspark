                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input placeholder="Email" {...field} className="pl-10" disabled={loading || googleLoading} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input type="password" placeholder="Password" {...field} className="pl-10" disabled={loading || googleLoading} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
